...
func (r *SubmarineReconciler) newSubmarineMinioPersistentVolumeClaim(ctx context.Context, submarine *submarinev1alpha1.Submarine) *corev1.PersistentVolumeClaim {
...
func (r *SubmarineReconciler) newSubmarineMinioDeployment(ctx context.Context, submarine *submarinev1alpha1.Submarine) *appsv1.Deployment {
	l := log.FromContext(ctx)
...
func (r *SubmarineReconciler) newSubmarineMinioService(ctx context.Context, submarine *submarinev1alpha1.Submarine) *corev1.Service {
	l := log.FromContext(ctx)
...
func (r *SubmarineReconciler) createSubmarineMinio(ctx context.Context, submarine *submarinev1alpha1.Submarine) error {
	l := log.FromContext(ctx)
	l.Info("[createSubmarineMinio]")
