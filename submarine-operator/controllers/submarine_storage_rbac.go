...
func (r *SubmarineReconciler) newSubmarineStorageRole(ctx context.Context, submarine *submarinev1alpha1.Submarine) *rbacv1.Role {
...
func (r *SubmarineReconciler) newSubmarineStorageRoleBinding(ctx context.Context, submarine *submarinev1alpha1.Submarine) *rbacv1.RoleBinding {
	l := log.FromContext(ctx)
...
func (r *SubmarineReconciler) newSubmarineStorageServiceAccount(ctx context.Context, submarine *submarinev1alpha1.Submarine) *corev1.ServiceAccount {
	l := log.FromContext(ctx)
...
func (r *SubmarineReconciler) createSubmarineStorageRBAC(ctx context.Context, submarine *submarinev1alpha1.Submarine) error {
	l := log.FromContext(ctx)
	l.Info("[createSubmarineStorageRBAC]")
