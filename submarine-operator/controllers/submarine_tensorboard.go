...
func (r *SubmarineReconciler) newSubmarineTensorboardPersistentVolumeClaim(ctx context.Context, submarine *submarinev1alpha1.Submarine) *corev1.PersistentVolumeClaim {
...
func (r *SubmarineReconciler) newSubmarineTensorboardDeployment(ctx context.Context, submarine *submarinev1alpha1.Submarine) *appsv1.Deployment {
	l := log.FromContext(ctx)
...
func (r *SubmarineReconciler) newSubmarineTensorboardService(ctx context.Context, submarine *submarinev1alpha1.Submarine) *corev1.Service {
	l := log.FromContext(ctx)
...
func (r *SubmarineReconciler) createSubmarineTensorboard(ctx context.Context, submarine *submarinev1alpha1.Submarine) error {
	l := log.FromContext(ctx)
	l.Info("[createSubmarineTensorboard]")
